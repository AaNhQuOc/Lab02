    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row border border-primary bg-nen1">
                ...
                <div class="col-4 pt-2 text-center border-left border-primary">
                    Hồ sơ đăng ký
                </div>
            </div>
            <div class="row border border-primary">
                <div class="col-md-8">
                    ...
                    <div class="row mb-2 bg-nen1">
                        <div class="col-mb-12 text-center p-2">
                            Thông tin cá nhân
                       </div>                       
                    </div>
                     <div class="row mb-2">
                      ...
                      <div class="row mb-2">
                        <div class="col-md-12 text-center">
                            <asp:Button ID="btnDangKy" OnClick="btnDangKy_Click" runat="server" Text="Đăng ký" />
                        </div>
